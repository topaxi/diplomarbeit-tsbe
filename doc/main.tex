...
\begin{abstract}
  ...
  ist neu in einer Stadt, oder generell nicht über die lokalen Lokalitäten
  ...
  der Nutzwertanalyse wurden Technologie Entscheide evaluiert und getrofffen.
  Die Analyse hat gezeigt, dass moderne Technologien wie die JavaScript Library
  zuviel Komplexität mit sich bringen, um im Rahmen einer Diplomarbeit
  eingesetzt zu werden. Das Ergebnis der Nutzwertanalysen ist, dass mit dem
  Phoenix Framework auf einen klassischen Server-Side Rendered Ansatz gesetzt
  wird.\\
  \\
  ...
  Anforderungen umgesetzt, kleinere unerwartete Probleme hat zu Verzögerungen
  von weniger wichtigen Funktionalitäten geführt, welche zu einem späteren
  Zeitpunkt nachgeliefert werden.
\end{abstract}
