...
\includepdf[pages=1,pagecommand={\pagestyle{empty}\Hide\chapter{Projektinitialisierungsauftrag}}]{eingabe/Projektinitialisierungsauftrag.pdf}
\includepdf[pages=2-,pagecommand={\pagestyle{empty}}]{eingabe/Projektinitialisierungsauftrag.pdf}
