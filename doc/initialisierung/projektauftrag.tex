...
\begin{itemize}
  ...
  \item{}
        Die Richtlinien zum Erstellen des Diplomberichtes der \Gls{tsbe}.
...
einer klassischen \Gls{ssr} Applikation zu starten. Das Phoenix Framework bietet alle
...
eine kleinere JavaScript-\Gls{library} verwendet werden um die Problemlösung zu
vereinfachen.\\
...
sowie mit der Browser-Testing \Gls{library} «Wallaby».
